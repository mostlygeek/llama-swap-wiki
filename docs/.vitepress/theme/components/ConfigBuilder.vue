...
<template>
  <div class="config-builder-container">
    <div class="flex flex-col lg:flex-row gap-6" style="height: 600px;">
      <!-- Sidebar - Feature Selector -->
      <div class="lg:w-80 flex-shrink-0 flex flex-col min-h-0">
        <div class="bg-white rounded-lg shadow p-4 flex-1 overflow-hidden flex flex-col border border-gray-200">
          <FeatureSelector
